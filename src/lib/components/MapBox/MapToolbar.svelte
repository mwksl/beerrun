...
<!--<button type="button" class="single-click" on:click={() => dispatch('click-route')} title="Routing">-->
<!--  <svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M11 5h.01M12 19a9 9 0 100-18 9 9 0 000 18z"></path></svg>-->
<!--</button>-->
